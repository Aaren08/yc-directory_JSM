  ...
  const handleFormSubmit = async (prevState: any, formData: FormData) => {
    try {
      ...
      if (error instanceof z.ZodError) {
        ...
        sonnerToast.error("Please check your inputs and try again.", {
          description: "Error occurred during form validation",
        });
    ...
    <form action={formAction} className="startup-form">
      ...
      <div>
        ...
        <Input
          ...
          name="category"
          className="startup-form_input"
          placeholder="Startup Category (e.g. Health, Tech, Education)"
          required
        />
        {errors.category && (
